...
#SBATCH --mem=400gb                   # Job memory request ## Should have more than 300 here
...
List=(PoplarMybKO2  PoplarMybKO46  PoplarWT)

ml Anaconda3/2020.02
source activate r_env

Rscript /home/sb14489/Epigenomics/scATAC-seq/0_CoreScript/CleanFeatures_DetectDoublets.R \
 --WD /scratch/sb14489/3.scATAC/5.Poplar/5.CellClustering/ \
 --Name "${List[SLURM_ARRAY_TASK_ID]}" --PreFix Tn5CutDefault_Binsize500 --MinT 0.01 --MaxT 0.05 --nPC 100
