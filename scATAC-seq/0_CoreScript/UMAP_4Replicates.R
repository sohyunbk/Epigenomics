...
#obj_All$meta$sampleID <- gsub("bi3_Re1", "bif3_Re1", obj_All$meta$sampleID)
#obj_All$meta$sampleID <- gsub("bi3_Re2", "bif3_Re2", obj_All$meta$sampleID)
#saveRDS(obj_All,OldRDS)
