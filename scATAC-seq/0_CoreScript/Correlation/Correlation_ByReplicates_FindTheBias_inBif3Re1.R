...
A619_CPM <- A619_CPM[A619_CPM[,6]!=0,]
dim(A619_CPM)
colnames(A619_CPM)
...
CorrPlot_Function(Correlation,SampleName,Prefix="_Replicates_AllACRs_RemoveZeroInBif3Re2IMOC.pdf")
CorrPlot_Function(Correlation_Top2000,SampleName,Prefix="_Replicates_Top2000Variable_RemoveZeroInBif3Re2IMOC.pdf")
