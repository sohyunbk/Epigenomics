...
Peak_All <-read.table("/scratch/sb14489/3.scATAC/2.Maize_ear/8.CommonACRs/A619_Bif3/ComA619Bif3.unique500bpPeaks_Intergenic.bed",header=F)
dim(Peak_All)
...
Sparse_A619Re2 <- Sparse_A619[endsWith(Sparse_A619$cellID, 'A619_2'),]
Sparse_Bif3Re2 <- Sparse_Bif3[endsWith(Sparse_Bif3$cellID, 'bif3_2'),]

head(Sparse_Bif3Re2)
Sparse_A619Re2$Celltype <- paste0("A619Re2_",Sparse_A619Re2$Celltype)
Sparse_Bif3Re2$Celltype <- paste0("Bif3Re2_",Sparse_Bif3Re2$Celltype)

Sparse_Sum <- rbind(Sparse_A619Re2,Sparse_Bif3Re2)
head(Sparse_Sum)
dim(Sparse_Sum)
...
A619_Bif3_Celltype_Count_InterGenic <-  spread(A619_Bif3_Celltype,key = Celltype,value =accessability)
