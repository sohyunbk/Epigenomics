...
#1-GCACAGCAGCR fimo_out_1
#2-GCAGCATGC fimo_out_3
#4-CGCGCCGCGCC fimo_out_4
#3-YAGAGAGAGA fimo_out_5
#5-GCTAGCTAGC fimo_out_7
...
## Find overlap.
DEGInfo_A619Higher$chr <- sapply(strsplit(as.character(DEGInfo_A619Higher$Peak), "_"), `[`, 1)
DEGInfo_A619Higher$start <- as.integer(sapply(strsplit(as.character(DEGInfo_A619Higher$Peak), "_"), `[`, 2))
DEGInfo_A619Higher$end <- as.integer(sapply(strsplit(as.character(DEGInfo_A619Higher$Peak), "_"), `[`, 3))
DEG_ranges <- GRanges(
  seqnames = DEGInfo_A619Higher$chr,
  ranges = IRanges(start = DEGInfo_A619Higher$start, end = DEGInfo_A619Higher$end)
)
