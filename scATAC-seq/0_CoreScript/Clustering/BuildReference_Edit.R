...
## Substract A619.
setwd("/scratch/sb14489/3.scATAC/2.Maize_ear/5.CellClustering/Organelle5Per_CombineLater/A619/")

obj_A619_merged <- readRDS("A619_Tn5Cut1000_Binsize500_MinT0.01_MaxT0.05_PC100_RemoveBLonlyMitoChloroChIP_k50_res0.9.AfterHarmony.rds")
str(obj_A619_merged)
...
sym.ref <- readRDS("/scratch/sb14489/3.scATAC/2.Maize_ear/5.CellClustering/Ref_AfterMt0.5Cutoff/Tn5Cut1000_Binsize500_Mt0.05_MinT0.01_MaxT0.05_PC100/AnnV3_RemoveBLonlyMitoChloroChIP.ALL_CELLs_BeforeCluster.symphony_reference.rds")
obj_A619_merged
str(obj_A619_merged)
str(sym.ref)
