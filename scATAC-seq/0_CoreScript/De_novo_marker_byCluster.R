...
output_locaiton <- "/scratch/sb14489/3.scATAC/2.Maize_ear/6.Annotation/3.Denovo/AnnV3"
...
generate_sample_matrix_replicate_aware <- function(combined_sparse){
  ...
  final_sample_df$replicate <- factor(final_sample_df$replicate, levels = c("A619_Re1", "A619_Re2"))
