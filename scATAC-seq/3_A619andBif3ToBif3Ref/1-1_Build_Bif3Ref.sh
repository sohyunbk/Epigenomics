...
cellranger-atac mkref --config=CellRangerv2-ATAC_Maizev5_Bif3.config ## In protocl they are saying it should be gtf but gff seems fine in v1 but in v2 it should be gtf
