...
#SBATCH --output=/scratch/sb14489/0.log/FindSamLines_Bif3.%j.out   # Standard output log
#SBATCH --error=/scratch/sb14489/0.log/FindSamLines_Bif3.%j.err    # Standard error log
...
cd $Path
# Input files
input_file_a="Bif3_Re2_ToBif3Ref_Added500bp.intersect"
input_file_b="/scratch/sb14489/3.scATAC/4.Bif3Ref/4.Bam_FixingBarcode/3_bif3_2_BarcodeFixed.sam"

# Output file
output_file="Bif3_Re2_ToBif3Ref_Added500bp.sam"
