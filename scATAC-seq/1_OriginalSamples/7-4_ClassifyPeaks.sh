...
~/.conda/envs/r_env/bin/python /home/sb14489/1.scATAC-seq/1_scATAC-seq/0_CoreScript/0_Functions/ClassifyPeaks_Intergenic_Genic.py \
 -PeakFile /scratch/sb14489/3.scATAC/2.Maize_ear/7.PeakCalling/Ann_V3_RemoveFakePeak/"${Sample[SLURM_ARRAY_TASK_ID]}"/"${Sample[SLURM_ARRAY_TASK_ID]}".500bp_peaks.FilteredOrgs.bed  \
 ...
 -OutfilePath /scratch/sb14489/3.scATAC/2.Maize_ear/7.PeakCalling/Ann_V3_RemoveFakePeak/"${Sample[SLURM_ARRAY_TASK_ID]}"/ \
 -OutfileName "${Sample[SLURM_ARRAY_TASK_ID]}".500bp_peaks
