...
Infile_bed=/scratch/sb14489/3.scATAC/2.Maize_ear/8.Comparative_Analysis/2.dACR/A619_vs_Bif3_AnnV4/"${Celltype[SLURM_ARRAY_TASK_ID]}".FDR0.05A619Higher.bed
OutfilePathName=/scratch/sb14489/3.scATAC/2.Maize_ear/10.MotifAnalysis/3.fimo/Revision_"${Celltype[SLURM_ARRAY_TASK_ID]}".FDR0.05A619Higher
