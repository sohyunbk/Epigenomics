#!/bin/bash
#SBATCH --job-name=GeneBodyA        # Job name
#SBATCH --partition=highmem_p         # Partition (queue) name
#SBATCH --ntasks=1                    # Run a single task
#SBATCH --cpus-per-task=1             # Number of CPU cores per task
#SBATCH --mem=90gb                   # Job memory request ## Should have more than 300 here
#SBATCH --time=2:00:00               # Time limit hrs:min:sec
#SBATCH --output=/scratch/sb14489/0.log/GeneBodyA.%j.out   # Standard output log
#SBATCH --error=/scratch/sb14489/0.log/GeneBodyA.%j.err    # Standard error log
...
Rscript /home/sb14489/Epigenomics/scATAC-seq/0_CoreScript/GeneBodyA_Submit.R \
 ...
 --Re2_bed /scratch/sb14489/3.scATAC/2.Maize_ear/4.Bam_FixingBarcode/2_rel2_2_Unique.bed \
