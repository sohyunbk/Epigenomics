...
Ex <- function(){
  ...
  SampleS <- "A619"
  PreOptions_forRe3Re3 <- "Tn5Cut1000_Binsize500_MinT0.005_MaxT0.01_PC100"
  WD_forRe3Re3 <- "/scratch/sb14489/3.scATAC/2.Maize_ear/5.CellClustering/AdditionalSample_TSS3_FRiP4/"
  Re3 <- "A619_Re3"
  Re4 <- "A619_Re4"
}
...
obj_Re3 <- readRDS(paste0(WD_forRe3Re3,"/",Re3,"/",Re3,"_",PreOptions_forRe3Re3,".rds"))
obj_Re4 <- readRDS(paste0(WD_forRe3Re3,"/",Re4,"/",Re4,"_",PreOptions_forRe3Re3,".rds"))
