...
Rscript ../workflow_scripts/Annotation_Cluster/GeneBodyA_Submit.R \
 --Ann /scratch/sb14489/0.Reference/Maize_B73/Zm-B73-REFERENCE-NAM-5.0_Zm00001eb.1_MtPtAdd_Rsf_AddZmCLE7Extended500bp.gtf \
 ...
 --OutFileName /scratch/sb14489/3.scATAC/2.Maize_ear/4.Bam_FixingBarcode/GA_"${OutfileNames[SLURM_ARRAY_TASK_ID]}"_includingZmCLE7Extended500bp.txt
