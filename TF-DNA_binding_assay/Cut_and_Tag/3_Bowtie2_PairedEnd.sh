...
#SBATCH --time=5:00:00               # Time limit hrs:min:sec #For normal fastq : more than at least five days with 14 cpu 80 hours
...
-2 ./2.Trimmomatic/"${Sample[SLURM_ARRAY_TASK_ID]}"_reverse_paired.fastq -p 20  \
| samtools view -bS - > ./3.Bowtie2/"${Sample[SLURM_ARRAY_TASK_ID]}"_bowtie2_algn.bam
