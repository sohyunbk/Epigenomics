...
#SBATCH --mem=30gb                   # Job memory request #For normal fastq : 600gb
...
#samtools sort -@ 24 /scratch/sb14489/7.DAPorChIP/CUTandTAG/3.Bowtie2/"${Sample[SLURM_ARRAY_TASK_ID]}"_bowtie2_algn.bam \
# -o /scratch/sb14489/7.DAPorChIP/CUTandTAG/3.Bowtie2/"${Sample[SLURM_ARRAY_TASK_ID]}"_bowtie2_algn_Sorted.bam
...
#  -bam /scratch/sb14489/7.DAPorChIP/CUTandTAG/3.Bowtie2/"${Sample[SLURM_ARRAY_TASK_ID]}"_bowtie2_algn_Sorted.bam

source activate ucsc
wigToBigWig \
/scratch/sb14489/7.DAPorChIP/CUTandTAG/3.Bowtie2/"${Sample[SLURM_ARRAY_TASK_ID]}"_bowtie2_algn_Sorted.bg \
/scratch/sb14489/0.Reference/Maize_B73/Zm-B73-REFERENCE-NAM-5.0_MtPtAdd_Rsf.fa.fai \
/scratch/sb14489/7.DAPorChIP/CUTandTAG/3.Bowtie2/"${Sample[SLURM_ARRAY_TASK_ID]}"_bowtie2_algn_Sorted.bw
