...
CellTypes = ["BundleSheath_VascularSchrenchyma","ProcambialMeristem_ProtoXylem_MetaXylem","SPM-base_SM-base","IM-OC","IM_SPM_SM","XylemParenchyma_PithParenchyma","ProtoPhloem_MetaPhloem_CompanionCell_PhloemParenchyma","CalloseRelated","FloralMeristem_SuppressedBract","L1atFloralMeristem","PhloemPrecursor"]
