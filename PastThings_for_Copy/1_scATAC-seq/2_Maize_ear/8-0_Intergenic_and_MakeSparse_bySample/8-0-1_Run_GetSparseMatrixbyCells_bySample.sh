...
awk '$1 ~ /^chr/' /scratch/sb14489/3.scATAC/2.Maize_ear/4.Bam_FixingBarcode/"${BedFileName[SLURM_ARRAY_TASK_ID]}" \
 > /scratch/sb14489/3.scATAC/2.Maize_ear/4.Bam_FixingBarcode/"${BedFileName[SLURM_ARRAY_TASK_ID]}"_OnlyChr
...
bedtools intersect -a /scratch/sb14489/3.scATAC/2.Maize_ear/4.Bam_FixingBarcode/"${BedFileName[SLURM_ARRAY_TASK_ID]}"_OnlyChr \
 -b "$PeakDir"/"${Sample[SLURM_ARRAY_TASK_ID]}"/"${Sample[SLURM_ARRAY_TASK_ID]}".500bp_peaks.FilteredOrgs.bed \
 -wa -wb \
 | /home/sb14489/.conda/envs/Jbrowse/bin/perl ~/1.scATAC-seq/1_scATAC-seq/0_CoreScript/8-1_FindCommonACRPos/8-3_fastSparse.nonbinary.peak.pl - > "$PeakDir"/"${Sample[SLURM_ARRAY_TASK_ID]}"/"${Sample[SLURM_ARRAY_TASK_ID]}".500bp_peaks.sparse
