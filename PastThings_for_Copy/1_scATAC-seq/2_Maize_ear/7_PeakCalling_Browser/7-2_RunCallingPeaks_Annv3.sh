...
Path=/scratch/sb14489/3.scATAC/2.Maize_ear/7.PeakCalling/Ann_v3
...
~/.conda/envs/r_env/bin/python /home/sb14489/1.scATAC-seq/1_scATAC-seq/0_CoreScript/7_PeakCalling_Browser/7-2_call_scACRs.py \
 ...
 -meta /scratch/sb14489/3.scATAC/2.Maize_ear/5.CellClustering/Ref_AfterMt0.5Cutoff/Tn5Cut1000_Binsize500_Mt0.05_MinT0.01_MaxT0.05_PC100/AnnotationV3."${Sample[SLURM_ARRAY_TASK_ID]}".metadata.txt \
