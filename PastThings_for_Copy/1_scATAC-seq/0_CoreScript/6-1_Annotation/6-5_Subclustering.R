...
head(loaded_meta_data)
str(obj_A619_merged)
SelectedCluster <- loaded_meta_data[which(loaded_meta_data$LouvainClusters=="8"),]
head(SelectedCluster)
...
pdf(paste0(out,"_Cluster4_Sub_res0.2_knear3.pdf"), width=10, height=10)
