...
RunSubClusterMarker <- function(Name,Meta){
  
#WD <- "/scratch/sb14489/3.scATAC/2.Maize_ear/6.Annotation/1.MarkerGene/SubCluster1"
#Name <- "SubCluster3_Sub_Only"
meta <- paste0("/scratch/sb14489/3.scATAC/2.Maize_ear/5.CellClustering/Ref_AfterMt0.5Cutoff/Tn5Cut1000_Binsize500_Mt0.05_MinT0.01_MaxT0.05_PC100/",Meta)
...
RunSubClusterMarker("SubCluster1_res1_knear100","Cluster1_Recluster_Sub_res1_knear100_Partmetadata.txt")
RunSubClusterMarker("SubCluster3_res1_knear100","Cluster3_Recluster_Sub_res1_knear100_Partmetadata.txt")
RunSubClusterMarker("SubCluster4_res1_knear100","Cluster4_Recluster_Sub_res1_knear100_Partmetadata.txt")
RunSubClusterMarker("SubCluster7_res1_knear100","Cluster7_Recluster_Sub_res1_knear100_Partmetadata.txt")
