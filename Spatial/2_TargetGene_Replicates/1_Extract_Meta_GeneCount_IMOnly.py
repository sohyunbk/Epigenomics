...
barcode_set = CZ.index.tolist()
CZ_Count = cell_gene_count_raw.loc[cell_gene_count_raw.index.isin(barcode_set)]
CZ_Count.to_csv('/scratch/sb14489/9.spatialRNAseq/3.TargetGene_IMOnly/A619_D_WTCZOnly_new.csv', index=True, header=True)
...
barcode_set = CZ.index.tolist()
CZ_Count = cell_gene_count_raw.loc[cell_gene_count_raw.index.isin(barcode_set)]
CZ_Count.to_csv('/scratch/sb14489/9.spatialRNAseq/3.TargetGene_IMOnly/A619_D_Bif3CZOnly.csv', index=True, header=True)
