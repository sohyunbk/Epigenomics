...
bowtie2 -x /scratch/sb14489/0.Reference/TAIR10/TAIR10 -U /scratch/sb14489/7.DAPorChIP/CHIPseq_Ara_WUS/1.SRADownload/"${Sample[SLURM_ARRAY_TASK_ID]}"/"${Sample[SLURM_ARRAY_TASK_ID]}".fastq \
 -S /scratch/sb14489/7.DAPorChIP/CHIPseq_Ara_WUS/2.Mapped/"${Sample[SLURM_ARRAY_TASK_ID]}"_bowtie2_algn.sam -p 20 2> /scratch/sb14489/7.DAPorChIP/CHIPseq_Ara_WUS/2.Mapped/"${Sample[SLURM_ARRAY_TASK_ID]}".log
